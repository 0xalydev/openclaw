...
async function prepareSetupProviderAuthChoice(
  ...
  // The plan owns callbacks through materialization; the lease covers only their import.
...
export async function buildTestPlan(params: {
  ...
  return await withPluginCache(cache, async (): ReturnType<typeof buildTestPlan> => {
