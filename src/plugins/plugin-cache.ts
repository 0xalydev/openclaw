...
import type { PluginHostCleanupResult } from "./host-hook-cleanup.js";
import {
...
export interface PluginCache
  ...
  setupModules: Map<string, PluginInstanceHandle>;
  instances: Set<PluginInstanceHandle>;
...
export function retirePluginCacheInstance(
  ...
  const completion = pluginInstanceState.invocation
